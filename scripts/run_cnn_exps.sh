...
do
   ...
   CUBLAS_WORKSPACE_CONFIG=:4096:8 python ./src/mnist_cnn.py --init quantum --pickle-stats --seed $i --storage ./numbers/storage-2-manhattan-unshuffled-32bit-080321.pkl --storage-pos $((121920*$i))
done
